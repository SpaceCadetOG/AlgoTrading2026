# Volume Profile Book Completion Packet
...
- daily_session profile
- rolling_3d profile
- VWAP session context
- daily open and failed-auction studies
- latest L2 context for spread and imbalance

### swing

- rolling_7d profile
- composite_30d profile
- accumulation and trend setup studies
- setup comparison and quality reviews

### long-term

- composite_30d profile
- profile shape study
- major POC/VAH/VAL context
- research-only, no investing strategy implemented
...
- splits
- assumptions
- risk-enforced research path

### research/

- CSV/JSON/Markdown reports for all book-derived research layers
