...
|---:|---|---|---|---:|---|
| 1 | rsi | KEEP_THROTTLED | THROTTLE | -41.46 | high_variance |
...
| 4 | vol_mean_reversion | KEEP_THROTTLED | THROTTLE | -53.58 | low_sharpe, negative_expectancy, poor_risk_grade |
| 5 | macd | KEEP_THROTTLED | THROTTLE | -60.96 | low_sharpe, negative_expectancy, excessive_trades_per_day, poor_risk_grade |

## Strategies Kept Throttled

| Rank | Strategy | Gate | Decision | Score | Reasons |
|---:|---|---|---|---:|---|
| 1 | rsi | KEEP_THROTTLED | THROTTLE | -41.46 | high_variance, top_ranked_throttle |
...
| 4 | vol_mean_reversion | KEEP_THROTTLED | THROTTLE | -53.58 | low_sharpe, negative_expectancy, poor_risk_grade, top_ranked_throttle |
| 5 | macd | KEEP_THROTTLED | THROTTLE | -60.96 | low_sharpe, negative_expectancy, excessive_trades_per_day, poor_risk_grade, top_ranked_throttle |
...
| 8 | apo | REWRITE_REQUIRED | THROTTLE | -68.41 | low_sharpe, negative_expectancy, poor_risk_grade, low_risk_adjusted_rank |
| 9 | sma | REWRITE_REQUIRED | THROTTLE | -69.75 | low_sharpe, negative_expectancy, excessive_trades_per_day, poor_risk_grade, low_risk_adjusted_rank |
...
| Rank | Strategy | Gate | Decision | Score | Reasons |
|---:|---|---|---|---:|---|
| 13 | ema | REMOVE_FROM_CANDIDATES | BLOCK | -144.45 | low_sharpe, negative_expectancy, excessive_trades_per_day, poor_risk_grade, blocked_by_risk_filter, severe_risk_adjusted_score |
